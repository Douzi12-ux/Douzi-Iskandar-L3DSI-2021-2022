...
export default defineComponent({
   data() {
    ...
    add(){
      ...
      stock.append('image', this.image)
      stock.append('articleRef', this.articleRef)
      stock.append('articleNom', this.articleNom)
      stock.append('articlePrixVente', this.articlePrixVente)
      stock.append('articleQte', this.articleQte)
      stock.append('fournisseur', this.fournisseur)
      axios.post(this.url+'/api/addstock', stock)
        .then(async () => {
