...
width: 78%;">
                ...
                <div class="card-header">
                    <h4>Reclamation
                        <a href="add_reclamationn" class="btn btn-primary float-end">Ajouter Reclamation</a>
                ...
                <div class="card-body">
                    ...
                    <table id="tablereclamations" class="table table-sm table-responsive-sm table-hover">
                        ...
                        <tbody>
                            @foreach($reclamatione as $key => $reclamation)
                            @if (Auth::user()->name==$reclamation->nom)
                            ...
                            <tr style="text-align: center">
                                ...
                                @if ($reclamation->status==0)
                                    <td>En Cours .. </td>
                                    <td>
                                        <a href="{{route('showchef',$reclamation->id   )}}" class="btn btn-info btn-sm">Plus Details</a>

                                    </td>
                                    @elseif ($reclamation->status==1)
                                    <td><span class="fa fa-check pl-3"></span></td>
                                    <td><a href="{{route('showchef',$reclamation->id   )}}" class="btn btn-info btn-sm">Plus Details</a></td>
                                    @else
