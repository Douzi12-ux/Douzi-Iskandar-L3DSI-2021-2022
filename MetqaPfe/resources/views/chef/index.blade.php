        ...
        <div class="collapse navbar-collapse w-auto ps ps--active-y" id="sidenav-collapse-main">
          <ul class="navbar-nav">
            <li class="nav-item">
              ...
              <li class="nav-item">
                  <a class="nav-link active" href="{{route('chefarchive')}}">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
...
width: 79%;">
                ...
                <div class="card-header">
                    <h4>Archive
                        <a href="add_chefarchive" class="btn btn-primary float-end">Ajouter Fichier</a>
                ...
                <div class="card-body">
                    ...
                    <table id="tablearchves" class="table table-sm table-responsive-sm table-hover">
                        <thead>
                        ...
                        <tbody>
                            @foreach($chefarchive as $key => $archiv)
                            <tr class="text-center">
                                ...
                                <td >
                                    ...
                                    <form action="{{route('supparchivee',$archiv->id)}}" method="post">
                                        @csrf
                                        @method('delete')
