...
<div class="container card" style="    margin: 90px;
margin-left: 300px;
width: 100%;">
 <div class="card-header">
    ...
    @endif
            ...
            <table id="tablearrecl"class="table table-sm table-responsive-sm table-hover">
                <thead>
                ...
                <tbody>
                    ...
                    <tr style="text-align: center">
                        ...
                        <td class="text-center">
                                ...
                                <a href="{{route('reclamationshow',$reclamation->id   )}}" class="btn btn-info btn-sm">Plus Details</a>
