...
width: 78%;">
                ...
                <div class="card-header">
                    <h4>Partenaire
                        <a href="add_fournisseur" class="btn btn-primary float-end">Ajouter Partenaire</a>
...
@endif
                ...
                <div class="card-body">
                    ...
                    <table id="tablefourniseurs" class="table table-sm table-responsive-sm table-hover">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <form action="{{route('supp',$four->id)}}" method="post">
                                        @csrf
                                        @method('delete')
                                        <a href="{{route("fournisseuredit",$four->id)}}" class="btn btn-success ">Modifier</a>
