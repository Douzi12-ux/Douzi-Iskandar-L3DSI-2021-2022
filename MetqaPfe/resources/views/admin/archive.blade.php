        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>Archive
                        <a href="add_fichierr" class="btn btn-primary float-end">Ajouter Fichier</a>
                ...
                <div class="card-body">
                    ...
                    <table id="tablearchives" class="table table-sm table-responsive-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td >
                                    ...
                                    <form action="{{route('suppfileefile',$archiv->id)}}" method="post">
                                        @csrf
                                        @method('delete')
