...
@endsection
@section('content')
<div class="container card" style="margin: 100px;
margin-left:16%;
">
        ...
        <div class="col-md-20" >
            ...
            <div class="card" >
                <div class="card-header">
                    <h4>Les Commandes
                        <a href="commandee" class="btn btn-primary float-end">Tout Les Commande</a>
                    </h4>
                </div>
                <div class="card-body" >
                    <table class="table table-sm table-responsive-sm table-hover">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>{{$commande->systemNom}}</td>
                                <td>{{$commande->systemPrix }}</td>
                                <td>{{$commande->systemQte }}</td>
                                <td>{{$commande->prixTotale }}</td>


                                <td><button type="submit" class="fa fa-check pl-3" >Confirmer</button></td>
