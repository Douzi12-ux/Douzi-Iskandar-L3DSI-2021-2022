...
@endif
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('add_stock') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3" >
                            <label for="">Reference d'article</label>
                            <input type="text" name="articleRef" required class="form-control">
                        </div>
                        @error('articleRef')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="articleNom" required class="form-control">
                        </div>

                        <div class="mb-3">
                            <label for="">Prix d'article</label>
                            <input type="text" name="articlePrixVente" required class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="">Quantite d'article</label>
                            <input type="text" name="articleQte" required class="form-control">
                        </div>
                        <div class="mb-3">
                            <label for="">Fournisseur OU Partenaire</label>
                        <select name="fournisseur" id="idfournisseur" class="form-control" required>
